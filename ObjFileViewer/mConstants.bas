...
Private Sub InitMaterials()
    ...
    With MatRed
        ...
        .Shininess = 300
    End With
    Set MatYellow = gCtl.NewMaterial
    With MatYellow
        .Face = faceFront
        .SetAmbient 1, 1, 0
        .SetDiffuse 1, 1, 0
        ...
        .Shininess = 300
    End With
    Set MatOrange = gCtl.NewMaterial
    With MatOrange
        .Face = faceFront
        .SetAmbient 0.6, 0, 0
